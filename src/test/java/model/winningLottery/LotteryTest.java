...
class LotteryTest {
    ...
    void 당첨번호와_보너스숫자를_입력받아_몇등인지_구한다_1등() {
        ...
        WinningBonusNumber winningBonusNumber = new WinningBonusNumber(7);

        Lottery lottery = new Lottery(winningNumbers, winningBonusNumber);
        Ranking rank = lottery.rank(new LottoNumbers(List.of(1, 2, 3, 4, 5, 6)));
    ...
    void 당첨번호와_보너스숫자를_입력받아_몇등인지_구한다_2등() {
        ...
        Lottery lottery = new Lottery(winningNumbers, winningBonusNumber);
        Ranking rank = lottery.rank(new LottoNumbers(List.of(1, 2, 7, 4, 5, 6)));
    ...
    void 당첨번호와_보너스숫자를_입력받아_몇등인지_구한다_3등() {
        ...
        Lottery lottery = new Lottery(winningNumbers, winningBonusNumber);
        Ranking rank = lottery.rank(new LottoNumbers(List.of(1, 2, 3, 4, 5, 8)));
